                    ...
                    <div className="artistInfoContent">
                        ...
                        <div className="artistInfoDescriptionWindow" style={{ display: (isDescriptionWindowOpen ? "block" : "none") }}>
                            ...
                            <div className="artistInfoDescriptionWindowHeader">
                                ...
                                <div className="artistInfoDescriptionWindowBtn" onClick={() => setIsDescriptionWindowOpen(false)}>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" height="24" viewBox="0 0 24 24" width="24" focusable="false">
